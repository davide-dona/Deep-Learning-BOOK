...
\node[inner sep=0, outer sep=0] (googlenet) at (0,0) {\includegraphics[angle=90,origin=c,width=4cm,height=8.5cm]{chapters/05-Convolutional-Neural-Networks/tikz/GoogleNet.pdf}};
\node[fit=(googlenet)] {};
