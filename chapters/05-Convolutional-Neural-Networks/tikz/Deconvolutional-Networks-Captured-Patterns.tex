...
\begin{document}
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/Deconvolutional-Networks-Captured-Patterns-Image.png}};
