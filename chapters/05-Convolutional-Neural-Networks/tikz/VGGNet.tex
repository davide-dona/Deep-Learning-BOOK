...
\node[canvas is zy plane at x=0, draw,outer sep=0pt,inner sep=0pt] (AA) at (0,0) {\includegraphics[width=13cm,height=12cm]{chapters/05-Convolutional-Neural-Networks/tikz/VGGNet.jpg}};
\end{scope}
%-----------------------------------
