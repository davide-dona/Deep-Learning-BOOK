...
% Visible Patches
\node[patch] (p1) at (-2.1,2.1) {\includegraphics[width=0.5cm]{images/mosaic2/00.jpg}};
\node[patch, right=-0.15cm of p1] (p2) {\includegraphics[width=0.5cm]{images/mosaic2/01.jpg}};
\node[patch, right=-0.15cm of p2] (p3) {\includegraphics[width=0.5cm]{images/mosaic2/03.jpg}};
\node[patch, right=-0.15cm of p3] (p4) {\includegraphics[width=0.5cm]{images/mosaic2/12.jpg}};
\node[patch, right=-0.15cm of p4] (p5) {\includegraphics[width=0.5cm]{images/mosaic2/21.jpg}};
\node[patch, right=-0.15cm of p5] (p6) {\includegraphics[width=0.5cm]{images/mosaic2/22.jpg}};
\node[patch, right=-0.15cm of p6] (p7) {\includegraphics[width=0.5cm]{images/mosaic2/23.jpg}};
\node[patch, right=-0.15cm of p7] (p8) {\includegraphics[width=0.5cm]{images/mosaic2/33.jpg}};
